 ...
 *
 * Copyright (c) 2016 by Babak Falsafi and James Hoe,
...
module mips_mem(addr1,data_in1,data_out1,data_out1_1,data_out1_2,data_out1_3,we1,excpt1,allow_kernel1,kernel1,
   ...
   output [31:0] data_out1_1;     // Memory read data
   output [31:0] data_out1_2;     // Memory read data
   output [31:0] data_out1_3;     // Memory read data
   reg [31:0] 	 data_out1;
   reg [31:0] 	 data_out1_1;
   reg [31:0] 	 data_out1_2;
   reg [31:0] 	 data_out1_3;
   ...
   initial
	...
	data_out1_1 = 32'hxxxxxxxx;
	data_out1_2 = 32'hxxxxxxxx;
	data_out1_3 = 32'hxxxxxxxx;
	excpt1 = 1'b0;
	kernel1 = 1'b0;
	...
	if((write_mask1 != 32'b0) && (rst_b == 1'b1))
	  ...
	  begin
	     ...
	     if((addr1 >= text_start_w) && (addr1 < text_top_w))
		  ...
		  data_out1_1 <= text_seg[addr1 +1 - text_start_w];
		  data_out1_2 <= text_seg[addr1 +2 - text_start_w];
		  data_out1_3 <= text_seg[addr1 +3 - text_start_w];
	       end
	     else if((addr1 >= data_start_w) && (addr1 < data_top_w))
	       begin
		  excpt1 <= 1'b0;
		  ...
		  data_out1_1 <= data_seg[addr1 +1 - data_start_w];
		  data_out1_2 <= data_seg[addr1 +2 - data_start_w];
		  data_out1_3 <= data_seg[addr1 +3 - data_start_w];
	       end
	     else if((addr1 >= stack_start_w) && (addr1 < stack_top_w))
	       begin
		  excpt1 <= 1'b0;
		  ...
		  data_out1_1 <= stack_seg[addr1 +1 - stack_start_w];
		  data_out1_2 <= stack_seg[addr1 +2 - stack_start_w];
		  data_out1_3 <= stack_seg[addr1 +3 - stack_start_w];
	       end
	     else if((addr1 >= ktext_start_w) && (addr1 < ktext_top_w))
	       begin
		  kernel1 <= 1'b1;
		  if(allow_kernel1 == 1'b1)
		    begin
		       ...
		       data_out1_1 <= ktext_seg[addr1 +1 - ktext_start_w];
		       data_out1_2 <= ktext_seg[addr1 +2 - ktext_start_w];
		       data_out1_3 <= ktext_seg[addr1 +3 - ktext_start_w];
		    end
		  else
		    begin
		       excpt1 <= 1'b1;
		  ...
		  if(allow_kernel1 == 1'b1)
		    begin
		       ...
		       data_out1_1 <= kdata_seg[addr1 +1 - kdata_start_w];
		       data_out1_2 <= kdata_seg[addr1 +2 - kdata_start_w];
		       data_out1_3 <= kdata_seg[addr1 +3 - kdata_start_w];
		    end
		  else
		    begin
		       excpt1 <= 1'b1;
