...
module mips_core_DW01_add_0 ( A, B, CI, SUM, CO );
  ...
  INVX1 U56 ( .A(\carry[4] ), .Y(SUM[3]) );
endmodule


module mips_core_DW01_add_1 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mips_core ( inst_addr, mem_addr, mem_data_in, mem_write_en, halted, clk, 
  ...
  wire   alusrc1, alusrc2, se, hi_en, lo_en, branchTrue, \_11_net_[31] ,
         ...
         \_11_net_[2] , \_15_net_[31] , \_15_net_[30] , \_15_net_[29] ,
         \_15_net_[28] , \_15_net_[27] , \_15_net_[26] , \_15_net_[25] ,
         \_15_net_[24] , \_15_net_[23] , \_15_net_[22] , \_15_net_[21] ,
         \_15_net_[20] , \_15_net_[19] , \_15_net_[18] , \_15_net_[17] ,
         \_15_net_[16] , \_15_net_[15] , \_15_net_[14] , \_15_net_[13] ,
         \_15_net_[12] , \_15_net_[11] , \_15_net_[10] , \_15_net_[9] ,
         \_15_net_[8] , \_15_net_[7] , \_15_net_[6] , \_15_net_[5] ,
         \_15_net_[4] , \_15_net_[3] , n8, n9;
  wire   [31:0] newpc;
  wire   [3:0] alu__sel;
  wire   [1:0] pcMuxSel;
  wire   [1:0] memtoreg;
  ...
  register_32_00400000 PCReg ( .q({inst_addr, pc}), .d(newpc), .clk(clk), 
        .enable(n9), .rst_b(rst_b) );
  register_32_00400004 PCReg2 ( .d(newpc), .clk(clk), .enable(n9), .rst_b(
        rst_b) );
  ...
  syscall_unit SU ( .syscall_halt(syscall_halt), .pc({inst_addr, pc}), .clk(
        ...
        1'b0}), .rst_b(rst_b) );
  register_width1_reset_value0 Halt ( .q(halted), .d(n8), .clk(clk), .enable(
        1'b1), .rst_b(rst_b) );
  ...
  mux2to1_0 dataToReg ( .out(wr_data), .in0(wr_dataMem), .in1({\_15_net_[31] , 
        \_15_net_[30] , \_15_net_[29] , \_15_net_[28] , \_15_net_[27] , 
        \_15_net_[26] , \_15_net_[25] , \_15_net_[24] , \_15_net_[23] , 
        \_15_net_[22] , \_15_net_[21] , \_15_net_[20] , \_15_net_[19] , 
        \_15_net_[18] , \_15_net_[17] , \_15_net_[16] , \_15_net_[15] , 
        \_15_net_[14] , \_15_net_[13] , \_15_net_[12] , \_15_net_[11] , 
        \_15_net_[10] , \_15_net_[9] , \_15_net_[8] , \_15_net_[7] , 
        \_15_net_[6] , \_15_net_[5] , \_15_net_[4] , \_15_net_[3] , 
        \_15_net_[2] , \_15_net_[1] , \_15_net_[0] }), .sel(jLink_en) );
  ...
  mips_core_DW01_add_0 add_311 ( .A({inst_addr, pc}), .B({1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b1, 1'b0, 1'b0, 1'b0}), .CI(1'b0), .SUM({\_15_net_[31] , 
        \_15_net_[30] , \_15_net_[29] , \_15_net_[28] , \_15_net_[27] , 
        \_15_net_[26] , \_15_net_[25] , \_15_net_[24] , \_15_net_[23] , 
        \_15_net_[22] , \_15_net_[21] , \_15_net_[20] , \_15_net_[19] , 
        \_15_net_[18] , \_15_net_[17] , \_15_net_[16] , \_15_net_[15] , 
        ...
        \_15_net_[10] , \_15_net_[9] , \_15_net_[8] , \_15_net_[7] , 
        \_15_net_[6] , \_15_net_[5] , \_15_net_[4] , \_15_net_[3] , 
        \_15_net_[2] , \_15_net_[1] , \_15_net_[0] }) );
  mips_core_DW01_add_1 r50 ( .A({inst_addr, pc}), .B({1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
  ...
  INVX1 U11 ( .A(n8), .Y(n9) );
  OR2X2 U12 ( .A(exception_halt), .B(syscall_halt), .Y(n8) );
endmodule
